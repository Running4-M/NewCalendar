...
// Declare auth in the outer scope
let auth;

// Initialize Firebase and then assign auth
initializeFirebase()
  .then(() => {
    auth = getAuth(); // Now it's safe to call getAuth()
    console.log("Firebase services are ready.");
    // You can optionally move your event listener code here if you prefer
  })
  .catch((error) => {
